...
export default {
    ...
    methods: {
        async getListMesas() {
            await this.axios({
                url: process.env.VUE_APP_DIRECCION_API_ADMINISTRADOR + '/software_la_tete_administrador/public/api/auth/listarMesas',
                method: 'GET',
                async: false
            })
                .then(response => {
        ...
        async getListCategorias() {
            await this.axios({
                url: process.env.VUE_APP_DIRECCION_API_ADMINISTRADOR + '/software_la_tete_administrador/public/api/auth/listarCategorias',
                method: 'GET',
                async: false
            })
                .then(response => {
        ...
        async getListProductos(idCategoriaSelected) {
            await this.axios({
                url: process.env.VUE_APP_DIRECCION_API_ADMINISTRADOR + '/software_la_tete_administrador/public/api/auth/listarProductoPorCategoria',
                method: 'GET',
                async: false,
        ...
        async getListFormaPago() {
            await this.axios({
                url: process.env.VUE_APP_DIRECCION_API_ADMINISTRADOR + '/software_la_tete_administrador/public/api/auth/listarFormaPago',
                method: 'GET',
                async: false
            })
                .then(response => {
        ...
        async cambiarStatusMesa(jsonStatusMesa) {
            await this.axios({
                url: process.env.VUE_APP_DIRECCION_API_ADMINISTRADOR + '/software_la_tete_administrador/public/api/auth/cambiarStatusMesa',
                method: 'GET',
                async: false,
                params: {
        ...
        async getProductoById(idProductoSelected) {
            await this.axios({
                url: process.env.VUE_APP_DIRECCION_API_ADMINISTRADOR + '/software_la_tete_administrador/public/api/auth/getProductoById',
                method: 'GET',
                async: false,
        ...
        async getDatosCabeceraOrdenPedido(idMesaSeleccionadaActual) {
            ...
            await this.axios({
                url: process.env.VUE_APP_DIRECCION_API_ADMINISTRADOR + '/software_la_tete_administrador/public/api/auth/getDatosCabeceraOrdenPedido',
                method: 'GET',
                async: false,
        ...
        async cobrarPedidoMesaSeleccionada(idMesaSeleccionadaActual) {
            ...
            await this.axios({
                url: process.env.VUE_APP_DIRECCION_API_ADMINISTRADOR + '/software_la_tete_administrador/public/api/auth/cobrarPedidoMesaSeleccionada',
                method: 'GET',
                async: false,
        ...
        createCabeceraOrdenPedido(jsonCreateOrdenPedido) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    this.axios({
                        url: process.env.VUE_APP_DIRECCION_API_ADMINISTRADOR + '/software_la_tete_administrador/public/api/auth/createOrdenPedido',
                        method: 'GET',
                        async: false,
                        params: {
